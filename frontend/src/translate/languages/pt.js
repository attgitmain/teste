    ...
    translations: {
      ...
      connections: {
        ...
        table: {
          ...
          maturationInProgress: "Chip em maturação",
        },
      },
      showTicketOpenModal: {
        title: {
      ...
      chipMaturation: {
        ...
        description:
          "Selecione uma conexão ativa e forneça mensagens exemplo. Elas serão enviadas automaticamente para manter o chip em uso.",
        chipLabel: "Selecione a Conexão",
        step_origin: "Escolha Origem",
        step_targets: "Escolha Destinos",
        step_schedule: "Defina Dias e Intervalo",
        step_messages: "Mensagens",
        daysLabel: "Dias",
       conversationLabel: "Conversas (uma por linha)",
       selectListsLabel: "Listas de Conversas",
