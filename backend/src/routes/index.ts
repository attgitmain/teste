...
import maturationRoutes from "./maturationRoutes";
import chipConversationRoutes from "./chipConversationRoutes";
...
routes.use(maturationRoutes);
routes.use(chipConversationRoutes);
